...
class Session extends Table with TableInfo<Session, SessionData> {
  ...
  late final GeneratedColumn<int> endTime = GeneratedColumn<int>(
    ...
    defaultValue: const CustomExpression('start_time'),
  );
  late final GeneratedColumn<int> ignoreAttendance = GeneratedColumn<int>(
    'ignore_attendance',
    aliasedName,
    false,
    type: DriftSqlType.int,
...
class SessionData extends DataClass implements Insertable<SessionData> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    map['ignore_attendance'] = Variable<int>(ignoreAttendance);
    return map;
  }
  ...
  factory SessionData.fromJson(
    ...
    return SessionData(
      ...
      ignoreAttendance: serializer.fromJson<int>(json['ignoreAttendance']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'ignoreAttendance': serializer.toJson<int>(ignoreAttendance),
    };
  }
...
class SessionCompanion extends UpdateCompanion<SessionData> {
  ...
  final Value<int> ignoreAttendance;
  ...
  static Insertable<SessionData> custom({
    ...
    Expression<int>? ignoreAttendance,
  }) {
    return RawValuesInsertable({
      if (id != null) 'id': id,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (ignoreAttendance.present) {
      map['ignore_attendance'] = Variable<int>(ignoreAttendance.value);
    }
    return map;
  }
